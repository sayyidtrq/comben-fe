...
# Replace CSS link
content = content.replace('href="../css/dashboard.css"', 'href="../css/dashboard-agent-lifecycle.css"')
# Replace Title
content = content.replace('<title>COMBEN - Dashboard</title>', '<title>COMBEN - Dashboard Agent Lifecycle</title>')

# Update Sidebar Active Link
# 1. Remove active from dashboard.html
content = content.replace('class="nav-link active" href="dashboard.html"', 'class="nav-link" href="dashboard.html"')
# 2. Add active to dashboard-agent-lifecycle.html
content = content.replace('class="nav-link" href="#"', 'class="nav-link active" href="dashboard-agent-lifecycle.html"')
content = content.replace('href="#"', 'href="dashboard-agent-lifecycle.html"') # Just replacing the # in the placeholder
...
new_content = re.sub(r'<main class="page-main">.*?</main>', main_content, content, flags=re.DOTALL)

# Replace script
new_content = new_content.replace('src="../js/dashboard.js"', 'src="../js/dashboard-agent-lifecycle.js"')
