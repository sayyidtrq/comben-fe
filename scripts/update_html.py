...
main_content = """    <main class="page-main">
      <section class="dashboard-page" aria-labelledby="dashboard-title">
        ...
        <div class="dashboard-al-grid">
          <!-- Pipeline Rekrutmen (Chevron Layout) -->
          <article class="al-card col-span-12">
            ...
            <div class="pipeline-chevrons">
              <div class="pipeline-chevron ch-new">New Applicant</div>
              <div class="pipeline-chevron ch-screen">Screening</div>
              <div class="pipeline-chevron ch-interview">Interview</div>
              <div class="pipeline-chevron ch-verify">Verification</div>
              <div class="pipeline-chevron ch-approved">Approved</div>
              <div class="pipeline-chevron ch-rejected">Rejected</div>
            </div>
          ...
          <!-- Distribusi Status Agen (With Custom Legend) -->
          <article class="al-card col-span-4">
            <div class="al-card-header">
            ...
            <div class="donut-layout">
              ...
              <div class="custom-legend" id="donutLegend">
                <!-- Injected via JS -->
              </div>
            </div>
