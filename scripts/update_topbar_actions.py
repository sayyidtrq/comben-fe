...
files_to_update = [
    'pages/modules.html',
    'pages/data-integration.html',
    'pages/data-mapping.html',
    'pages/data-quality.html',
    'pages/import-queue.html',
    'pages/integration-logs.html'
]
...
for filepath in files_to_update:
    if os.path.exists(filepath):
        ...
        # Replace from <div class="topbar-actions"> to </header>
        new_content = re.sub(r'<div class="topbar-actions">.*?</header>', replacement, content, flags=re.DOTALL)
